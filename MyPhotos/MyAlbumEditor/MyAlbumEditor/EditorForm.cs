...
namespace MyAlbumEditor
{
    public partial class EditorForm : Form
    {
        ...
        private void btbPhotoProps_Click(object sender, EventArgs e)
        {
        ...
        private void btnRrowse_Click(object sender, EventArgs e)
        {
            using (FolderBrowserDialog dlg = new FolderBrowserDialog())
            {
                dlg.Description = "Select an album fole directory to add to the dialog.";
